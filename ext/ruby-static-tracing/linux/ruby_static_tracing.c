...
void Init_ruby_static_tracing()
{
 ...
 /*
  ...
  rb_define_method(cTracepoint, "tracepoint_initialize", tracepoint_initialize, 4); // FIXME accept vargs
  rb_define_method(cTracepoint, "fire", tracepoint_fire, 2); // FIXME accept vargs
