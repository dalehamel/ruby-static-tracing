...
void Init_ruby_static_tracing()
{
 ...
 /*
  ...
  rb_define_method(cProvider, "tracepoint_initialize", tracepoint_initialize, 4); // FIXME accept vargs
  rb_define_method(cProvider, "fire", tracepoint_fire, 2); // FIXME accept vargs
  rb_define_method(cProvider, "enabled?", tracepoint_enabled, 0);
}
